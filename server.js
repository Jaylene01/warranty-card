...
'var h=document.querySelector(".records-hint");if(h)h.innerHTML="记录会保存到 Railway 数据库，可在不同设备/浏览器同步查看。首次打开会自动把当前浏览器旧记录迁移到数据库；点“编辑/重新导出”会把该条资料重新载入上方表单，你可以修改后再次导出图片或打印/存PDF。";' +
'refresh();' +
'})();' +
'</' + 'script>';
